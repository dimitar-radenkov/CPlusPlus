/*
 * MongoScenarioScreens.cpp
 *
 *  Created on: May 26, 2014
 *      Author: root
 */

#include "MongoScenarioScreens.h"

namespace database
{

MongoScenarioScreens::MongoScenarioScreens()
{
...
(const std::shared_ptr<ScreenDescription> screen) const
{
    ...
    {
        throw utils::CommonException("Unable to insert ScenarioScreens");
    }
}

std::shared_ptr<ScreenDescription>
MongoScenarioScreens::get(const uint16_t screenId) const
{
    ...
    catch(mongo::DBException &e)
    {
        throw utils::CommonException(
            this->buildErrorMessage(
                "Unable to get ScenarioScreens.", e).c_str());
    }
}

std::shared_ptr<ScreenDescription>
MongoScenarioScreens::get(const std::string &objectId) const
{
    mongo::BSONObjBuilder queryBuilder;
 ...
 const std::shared_ptr<ScreenDescription> updatedScreen) const
{
    ...
    {
        throw utils::CommonException(
            "Unable to update. Invalid ScenarioScreens pointer");
    }

    if(!this->isScreenExists(query))
    {
        throw utils::CommonException(
            "Unable to update. ScenarioScreens doesn't exists");
    }
    ...
    catch(mongo::DBException& e)
    {
        throw utils::CommonException(
            this->buildErrorMessage(
                "Unable to update ScenarioScreens", e).c_str());
    }
}

void MongoScenarioScreens::update(
...
void MongoScenarioScreens::remove(const uint16_t screenId) const
{
    mongo::BSONObjBuilder queryBuilder;
    queryBuilder.append("ScreenId", screenId);
    mongo::BSONObj query = queryBuilder.obj();
    ...
    {
        throw utils::CommonException(
            "Unable to remove. ScenarioScreens doesn't exists");
    }
    ...
    catch(mongo::DBException &e)
    {
        throw utils::CommonException(
            this->buildErrorMessage(
                "Unable to remove ScenarioScreens", e).c_str());
    }
}

void MongoScenarioScreens::remove(const std::string& objectId) const
{
    mongo::BSONObjBuilder queryBuilder;
    queryBuilder.append("_id", mongo::OID(objectId));
    mongo::BSONObj query = queryBuilder.obj();
...
MongoScenarioScreens::getAll() const
{
    ...
    catch(mongo::DBException& e)
    {
        throw utils::CommonException(
            this->buildErrorMessage(
                "Unable to get all ScenarioScreens", e).c_str());
    }
}

void MongoScenarioScreens::removeAll() const
{
    try
    {
        MongoDriver::getInstance().getConnection().
    ...
    catch(mongo::DBException &e)
    {
        throw utils::CommonException(
            this->buildErrorMessage(
                "Unable to remove all ScenarioScreens", e).c_str());
    }
}

mongo::BSONObj
MongoScenarioScreens::serialize
(const std::shared_ptr<ScreenDescription> screen) const
{
...
std::shared_ptr<ScreenDescription>
MongoScenarioScreens::unserialize
...
bool
MongoScenarioScreens::isScreenExists
...
const std::string MongoScenarioScreens::buildErrorMessage(
